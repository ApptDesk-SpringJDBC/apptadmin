...
public class RegistrationDetails {
	...
	public static List<RegistrationDetails> createDummyData() {
		
		List<RegistrationDetails> loginDetailsList = Lists.newArrayList();
		
		RegistrationDetails loginDetails = new RegistrationDetails();
		...
		RegistrationDetails loginDetails0 = new RegistrationDetails();
		...
		RegistrationDetails loginDetails1 = new RegistrationDetails();
		...
		RegistrationDetails loginDetails2 = new RegistrationDetails();
		...
		RegistrationDetails loginDetails3 = new RegistrationDetails();
